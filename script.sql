...
CREATE TABLE Proveedor (
    ...
    CONSTRAINT chk_proveedor_telefono CHECK (telefono LIKE '[0-9+()-]%' OR telefono IS NULL),
...
CREATE TABLE Articulo (
    ...
    CONSTRAINT chk_articulo_nombre CHECK (LEN(nombre) >= 3)
);
...
CREATE TABLE Categoria (
    ...
    CONSTRAINT chk_categoria_descripcion CHECK (LEN(descripcion) >= 5),
